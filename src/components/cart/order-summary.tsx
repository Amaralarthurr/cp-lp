...
export default function OrderSummary({ items, onCheckout }: OrderSummaryProps) {
  ...
  return (
    <div className="bg-cyber-gray/80 border border-cyber-green/50 rounded-lg p-6 hologram-effect backdrop-blur-sm">
      <h2 className="text-xl font-bold text-cyber-green mb-4 font-mono neon-text">[RESUMO_PEDIDO]</h2>
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-cyber-green to-cyber-cyan hover:from-cyber-pink hover:to-cyber-purple font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-cyber-green/50 neon-text font-mono disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {">>> FINALIZAR_COMPRA"}
      </button>
    </div>
