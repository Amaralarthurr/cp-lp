...
export default function QuizSection() {
  ...
  const handleAnswered = useCallback(({ isCorrect }: { isCorrect: boolean; points: number; explanation: string }) => {
    ...
    <section id="quiz" className="py-20 px-4 bg-cyber-darker relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-12 relative">
          <div
            className="fixed bottom-4 right-4 w-[360px] max-w-[85vw] z-50"
            style={{
              pointerEvents: robotVisible ? "auto" : "none",
